...
CREATE TABLE `boards` (
  ...
  KEY `FK_member_TO_boards_idx` (`member_idx`),
  CONSTRAINT `FK_member_TO_boards` FOREIGN KEY (`member_idx`) REFERENCES `members` (`member_idx`) ON DELETE RESTRICT ON UPDATE RESTRICT
